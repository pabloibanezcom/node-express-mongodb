...
module.exports = (app, modelDefinition, model) => {
    ...
    const createRoutes = () => {
        ...
        methods.getAll = () => {
            ...
            routesService.storeRoute(app, { model: modelDefinition.name, name: 'GetAll', method: 'GET', url: url });
        }
        ...
        methods.get = () => {
            ...
            app.get(url,
                getAuthCallback('get'),
                (req, res) => {
                    dbService.get(model, modelDefinition, req.param('id'))
                        .then(obj => res.send(obj))
                        .catch(error => console.log(error));
                });
            routesService.storeRoute(app, { model: modelDefinition.name, name: 'Get', method: 'GET', url: url });
        }
        ...
        methods.add = () => {
            ...
            routesService.storeRoute(app, { model: modelDefinition.name, name: 'Add', method: 'POST', url: url });
        }
        ...
        methods.update = () => {
            ...
            routesService.storeRoute(app, { model: modelDefinition.name, name: 'Update', method: 'PUT', url: url });
        }
        ...
        methods.remove = () => {
            ...
            routesService.storeRoute(app, { model: modelDefinition.name, name: 'Remove', method: 'DELETE', url: url });
        }
